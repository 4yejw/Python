...
class MainWindow(QMainWindow):
    ...
    def get_a_str(self):
        ...
        text1 = "my secret password"
        mode = QLineEdit.Password
        my_selected_str, ok = QInputDialog.gettext1(
            self, title, label, mode, text1
        )
        print("Result:", ok, my_selected_str)
    ...
    def get_text1(self):
        ...
        my_selected_str, ok = QInputDialog.getMultiLinetext1(
            self, title, label, text1
        )
        print("Result:", ok, my_selected_str)
